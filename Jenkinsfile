                  ...
                  <tr>
                    <td width="50%" height="232" valign="top" style="padding-right:5px;">
                      <table width="100%" height="232" cellpadding="0" cellspacing="0" style="border:1px solid #c7d2fe;border-radius:18px;overflow:hidden;background:#ffffff;">
                        <tr>
                          <td height="48" style="padding:0 16px;background:linear-gradient(90deg,#312e81 0%,#1d4ed8 48%,#0891b2 100%);color:#ffffff;font-size:14px;font-weight:900;vertical-align:middle;line-height:48px;">Execution Details</td>
                        </tr>
                        <tr>
                          <td height="184" valign="middle" style="padding:12px 14px;background:linear-gradient(180deg,#312e81 0%,#1e40af 55%,#0e7490 100%);">
                            <table width="100%" height="160" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#7c3aed 0%,#2563eb 38%,#0891b2 72%,#16a34a 100%);border:1px solid rgba(255,255,255,0.35);border-radius:14px;box-shadow:0 6px 22px rgba(49,46,129,0.28);">
                              <tr>
                                <td height="160" valign="middle" style="padding:12px 12px 8px;text-align:center;">
                                  <div style="font-size:10px;color:#ede9fe;font-weight:800;letter-spacing:1.2px;text-transform:uppercase;">Pass Rate</div>
                                  <div style="margin:6px 0 10px;font-size:40px;font-weight:900;line-height:1;color:#ffffff;text-shadow:0 2px 8px rgba(15,23,42,0.25);">${passRate}<span style="font-size:18px;color:#bfdbfe;">%</span></div>
                                  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:8px;">
                                    <tr>
                                      <td style="height:10px;background:rgba(255,255,255,0.28);border-radius:999px;font-size:0;line-height:0;">
                                        <div style="width:${passRate}%;max-width:100%;height:10px;background:linear-gradient(90deg,#fbbf24,#f472b6,#a78bfa,#38bdf8,#4ade80);border-radius:999px;"></div>
                                      </td>
                                    </tr>
                                  </table>
                                  <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(15,23,42,0.32);border:1px solid rgba(255,255,255,0.42);border-radius:10px;">
                                    <tr>
                                      <td style="padding:9px 12px;font-size:11px;font-weight:800;color:#bae6fd;">Duration</td>
                                      <td align="right" style="padding:9px 12px;font-size:12px;font-weight:900;color:#ffffff;">${durationString}</td>
                                    </tr>
                                  </table>
                                </td>
                              </tr>
