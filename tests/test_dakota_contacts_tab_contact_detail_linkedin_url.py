...
def test_dakota_contacts_tab_contact_detail_linkedin_url(dakota_page):
    """Open a company, click the first contact, and verify LinkedIn URL is displayed."""
    DakotaSidebarPage(dakota_page).verify_dakota_contacts_tab_contact_detail_linkedin_url(
        DAKOTA_MARKETPLACE_URL,
        DAKOTA_USERNAME,
        DAKOTA_PASSWORD,
        DAKOTA_CONTACTS_TAB_SEARCH_TERM,
